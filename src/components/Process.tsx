...
const Process: React.FC = () => {
  return (
    <section id="process" className="section-padding bg-brand-black text-white overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          <div className="lg:col-span-5 sticky top-32">
            <h2 className="text-[10px] font-bold tracking-[0.3em] text-brand-yellow mb-4 uppercase">The Blueprint</h2>
            <h3 className="text-2xl md:text-5xl font-display font-black leading-tight mb-6">
              A JOURNEY OF <br />
          ...
          <div className="lg:col-span-7 space-y-16">
            {PROCESS_STEPS.map((step) => (
              <div key={step.number} className="group relative pl-0 lg:pl-28">
                <div className="hidden lg:block absolute left-0 top-0 text-brand-yellow font-display text-4xl md:text-7xl font-black opacity-10 group-hover:opacity-40 transition-all duration-500">
                  {step.number}
                </div>
                <div className="border-b border-white/10 pb-10 group-hover:border-brand-yellow/50 transition-colors">
                  <div className="lg:hidden text-brand-yellow font-display text-2xl font-black opacity-40 mb-2">
                    {step.number}
                  </div>
                  ...
                  <div className="mt-6 flex items-center gap-4 text-brand-yellow opacity-100 lg:opacity-0 group-hover:opacity-100 transition-all duration-500 lg:-translate-x-4 lg:group-hover:translate-x-0">
